...
@Component({
  ...
  template: `
    ...
    <div class="grid place-items-center mt-10 text-2xl min-h-screen">
      <div class="mx-auto max-w-3xl text-gray-400 text-lg mb-[100px]">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Just Angular.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Just Angular, accessible from
              <a
                href="https://justangular.com"
                rel="external nofollow noopener"
                target="_blank"
                >https://justangular.com</a
              >
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: jahollarienea14&#64;gmail.com</li>
        </ul>
      </div>
    </div>
  `,
